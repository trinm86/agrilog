...
class SauRiengMuaApp extends StatefulWidget {
  final String search;
  const SauRiengMuaApp({super.key, required this.search});
...
class _MyAppState extends State<SauRiengMuaApp> {
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    TextFormField(
                      ...
                      keyboardType: const TextInputType.numberWithOptions(decimal: true), // Hiển thị bàn phím số
                      inputFormatters: [
  ...
  void initState() {
    ...
    bloc = CayTrongBloc.withParams(LoaiCay.saurieng, LoaiNhap.mua, _search.text);
    _itemsFuture = bloc.getAlls(_search.text);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        toolbarHeight: 50,
        title: const Text("Chi tiền Sầu riêng"),
                            ...
                            child: Table(
                              ...
                              children: [
                                ...
                                TableRow(
                                  ...
                                  children: [
                                    const Padding(padding: EdgeInsets.all(0)), // Chừa chỗ cho Edit Icon
                                    const Padding(padding: EdgeInsets.all(8.0), child: Text('Ngày', style: TextStyle(fontWeight: FontWeight.bold))),
                                    const Padding(padding: EdgeInsets.all(8.0), child: Text('Nội dung', style: TextStyle(fontWeight: FontWeight.bold))),
                                    const Padding(padding: EdgeInsets.all(8.0), child: Text('Giá', style: TextStyle(fontWeight: FontWeight.bold), textAlign: TextAlign.right)),
                                    const Padding(padding: EdgeInsets.all(8.0), child: Text('SL', style: TextStyle(fontWeight: FontWeight.bold), textAlign: TextAlign.right)),
                                    Padding(

...
class CaPheBanApp extends StatefulWidget {
  final String search;
  const CaPheBanApp({super.key, required this.search});
...
class _MyAppState extends State<CaPheBanApp> {
  ...
  void initState() {
    ...
    bloc = CayTrongBloc.withParams(LoaiCay.caphe,LoaiNhap.ban, _search.text);
    _itemsFuture = bloc.getAlls(_search.text);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        toolbarHeight: 50,
        title: const Text("Thu tiền Cà phê"),
